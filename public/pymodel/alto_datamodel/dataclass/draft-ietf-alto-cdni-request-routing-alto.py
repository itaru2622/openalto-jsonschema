...
class Footprint:
    ...
    footprint_value: Optional[List[str]] = None


@dataclass
class CDNICapability:
    capability_type: str
    capability_value: Optional[Union[str, float, List, bool, Dict[str, Any]]]


@dataclass
class ReqFilteredCDNIAdvertisement:
    cdni_capabilities: Optional[List[CDNICapability]] = None
...
@dataclass
class CDNIAdvertisementData:
    capabilities_with_footprints: List[BaseAdvertisementObject]


@dataclass
class InfoResourceCDNIAdvertisement(ResponseEntityBase):
    cdni_advertisement: CDNIAdvertisementData
