...
class IRDResourceEntriesModel(BaseModel):
    pass
...
class CalendarAttributes(BaseModel):
    ...
    cost_type_names: List[str] = Field(..., alias='cost-type-names', min_items=1)
    time_interval_size: float = Field(..., alias='time-interval-size')
    number_of_intervals: float = Field(..., alias='number-of-intervals')


class CalendarResponseAttributes(BaseModel):
    class Config:
        extra = Extra.allow
    ...
    calendar_start_time: str = Field(..., alias='calendar-start-time')
    time_interval_size: float = Field(..., alias='time-interval-size')
    number_of_intervals: float = Field(..., alias='number-of-intervals')
...
class ReqFilteredCostMap(BaseModel):
    ...
    cost_type: Optional[CostType] = Field(None, alias='cost-type')
    multi_cost_types: Optional[List[CostType]] = Field(
        None, alias='multi-cost-types', min_items=1
    )
    testable_cost_types: Optional[List[CostType]] = Field(
        None, alias='testable-cost-types', min_items=1
    )
    constraints: Optional[List[str]] = None
    or_constraints: Optional[List[OrConstraint]] = Field(
        None, alias='or-constraints', min_items=1
    )
    pids: Optional[PIDFilter] = None


class FilteredCostMapCapabilities2(FilteredCostMapCapabilities):
    max_cost_types: Optional[float] = Field(None, alias='max-cost-types')
    testable_cost_type_names: Optional[List[str]] = Field(
        None, alias='testable-cost-type-names', min_items=1
    )
...
class ReqEndpointCostMap1(BaseModel):
    class Config:
        extra = Extra.allow
...
class ReqFilteredCostMapModel(BaseModel):
    class Config:
        extra = Extra.allow
...
class FilteredCostMapCapabilities1(FilteredCostMapCapabilities):
    calendar_attributes: Optional[CalendarAttributes] = Field(
        None, alias='calendar-attributes'
    )
