...
#   filename:  draft-ietf-alto-cdni-request-routing-alto.json
...
class Footprint(BaseModel):
    ...
    footprint_type: Optional[str] = Field(None, alias='footprint-type')
    footprint_value: Optional[List[str]] = Field(
        None, alias='footprint-value', min_items=1
    )


class CDNICapability(BaseModel):
    class Config:
        extra = Extra.allow

    capability_type: str = Field(..., alias='capability-type')
    capability_value: Optional[Union[str, float, List, bool, Dict[str, Any]]] = Field(
        ..., alias='capability-value'
    )


class ReqFilteredCDNIAdvertisement(BaseModel):
    class Config:
        extra = Extra.allow

    cdni_capabilities: Optional[List[CDNICapability]] = Field(
        None, alias='cdni-capabilities'
    )
...
class BaseAdvertisementObject(BaseModel):
    class Config:
        extra = Extra.allow
...
class CDNIAdvertisementData(BaseModel):
    class Config:
        extra = Extra.allow

    capabilities_with_footprints: List[BaseAdvertisementObject] = Field(
        ..., alias='capabilities-with-footprints'
    )


class InfoResourceCDNIAdvertisement(ResponseEntityBase):
    cdni_advertisement: CDNIAdvertisementData = Field(..., alias='cdni-advertisement')
